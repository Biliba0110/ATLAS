...
ATLAS — небольшой self-hosted IPAM для домашней лаборатории. Проект помогает вести учет подсетей, диапазонов и устройств, а также отслеживать занятые адреса на основе записей в базе и `ping`-проверок.
